...
```
The next step now is to plot the map itself on top of its shadow. 
...
```
Both the proportional map can be combined with choropleth coloraion. The size of circles and the color density represent different variables. This is achievable with the following code:
